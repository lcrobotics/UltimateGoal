        ...
        switch (auto) {
            ...
            case SHOOT:
                ...
                if (!lock) {
                    ...
                    ((DcMotorEx) shooter.motor).setVelocity(
                            shooter.motor.getMotorType().getAchieveableMaxTicksPerSecond());
                }
            ...
            case ROTATECW:
                ...
                if (!rotateZeroCW && !rotateSingle) {
                    ...
                    if (getBatteryVoltage() >= 13 && !rotateQuad) {
                        // turn to the left
                        drive.driveRobotCentric(0, 0, -0.34);
                    ...
                    if (rotateQuad) {
                        // turn left
                        drive.driveRobotCentric(0, 0, -0.36);
                ...
                if (rotateZeroCW) {
                    // turn left
                    drive.driveRobotCentric(0, 0, -0.32);
            ...
            case DRIVETOMID:
                ...
                if (numRings == 4) {
                    ...
                    if (park == 0) {
                        ...
                        // drive to a bit more on the line
                        drive.driveRobotCentric(0, 0.47, 0);
            ...
            case ROTATECCW:
                ...
                // is A)
                if (rotateZeroCCW && time.milliseconds() >= 200) {
                    // turn right
                    drive.driveRobotCentric(0, 0, 0.36);
