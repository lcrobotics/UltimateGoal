...
public abstract class SuperOpExperimental extends OpMode {
    // power constants1
    ...
    public void init() {
        ...
        frontLeftDrive = new Motor(hardwareMap, "FrontLeftDrive", cpr, rpm,.775);
        ...
        backLeftDrive = new Motor(hardwareMap, "BackLeftDrive", cpr, rpm, .775);
        backLeftDrive.setZeroPowerBehavior(Motor.ZeroPowerBehavior.BRAKE);
        backRightDrive = new Motor(hardwareMap, "BackRightDrive", cpr, rpm, .825);
    ...
    public void drive() {
        ...
        if (Math.abs(gamepad1.left_stick_x) > THRESHOLD) {
            ...
            backLeftDrive.setMultiplier(.775);
            backRightDrive.setMultiplier(.825);
        }
